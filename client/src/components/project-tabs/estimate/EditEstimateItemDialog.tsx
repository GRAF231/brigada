...
import { EditDialogProps, EstimateItemFormData } from './types';

const EditEstimateItemDialog: React.FC<EditDialogProps> = ({
  open,
  onClose,
  onSave,
  formData,
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle>Редактировать позицию сметы</DialogTitle>
      <DialogContent>
        <TextField
          autoFocus
          margin="dense"
...
export default EditEstimateItemDialog;